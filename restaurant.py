...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Restaurant Management System By Hastansh Pandit",fg="steel blue",bd=10,anchor='w')
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By Hastansh Pandit",bd=2,relief=SUNKEN)
status.grid(row=7,columnspan=3,padx=10,pady=10)
